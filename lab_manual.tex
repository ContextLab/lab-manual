...
\newcommand{\labmeetingtime}{Wednesdays at 12:00pm}
...
\noindent \marginnote{\texttt{TASK:}
  ...
  a pull request with your edits so that everyone can benefit.}Every new lab member should read
...
If you encounter an error or problem you don't know how to fix, try checking the \href{https://github.com/ContextLab/lab-manual/tree/master/resources/FAQ.pdf}{ask a question, answer a question} document, where we maintain a log of common problems lab members run into and solutions. If your don't see a solution to your question there, consider adding the question so that you or someone else can later add the answer for future readers!
...
\item We deliver research products frequently, from a couple of weeks to
  ...
  Before you have some display of your work (a figure, a
...
\item Aim to get some amount of work done \textit{every single day} on
  ...
  future someone might be you!).  Remember that your
...
\item The most effective and efficient method of conveying information
  within a research team is face-to-face conversation.  We use
  the
...
\item Self-organizing and self-managing without externally assigned
  roles
\item Negotiating commitments with the Project Owner, one ``sprint'' at
  a time
\item Autonomous regarding how to reach commitments
...
\item (Ideally) members of a single team/project % should this be here?
\item Often acting in various leadership roles
\end{enumerate}
...
\item Having no management authority over the team (anyone with authority
  ...
  Coordinator)
\item Occasionally acting in a leadership role
...
\item \textbf{Collaborator.}  Collaborators are not formally part of
  ...
  following roles:
\begin{enumerate}
\item Providing data or share equipment
\item Providing occasional consulting services
\item Providing occasional feedback on project results
\item Carrying out minor analyses
\item Proofreading documents
\item Helping with administrative tasks such as scheduling
\item Helping with information technology tasks such as computer
  maintenance
...
\item \textbf{Lab meeting.}  We will have, as a lab, a regular weekly
  ...
  needs and interests. Attendees: all active lab members. % Subscribe to calendar \href{https://calendar.google.com/calendar?cid=NXRhNTBjZnY0dWloMGEwazhtMmRpOWRoam9AZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
\item \textbf{Project meetings.}  Several of our collaborative
  ...
  lab members.  % Subscribe to calendar \href{https://calendar.google.com/calendar?cid=NXRhNTBjZnY0dWloMGEwazhtMmRpOWRoam9AZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
  \item \textbf{Hackathons.}  We occasionally organize hackathon
    ...
    external collaborators.  % Subscribe to calendar \href{https://calendar.google.com/calendar?cid=NXRhNTBjZnY0dWloMGEwazhtMmRpOWRoam9AZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
  ...
  \marginnote{\texttt{NOTE:} Department talks and colloquia are listed on the \href{https://calendar.google.com/calendar/b/1?cid=bXAxYnVqYjM5dWQ1YmdtbW5xOXI4ZGJpdWtAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{PBS Department Events} calendar.}
  \item \textbf{Department talks and colloquia.} Each week the
    ...
    members.  % Subscribe to calendar \href{https://calendar.google.com/calendar?cid=bXAxYnVqYjM5dWQ1YmdtbW5xOXI4ZGJpdWtAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
    ...
    \item \textbf{Howdy weekly snippets.} Each week (via Slack), all
      ...
      Tuesday at the end of the day (5pm).  % is this true? I always have until 10am Wednesday to fill out my Howdy
      If you are an unpaid
...
\begin{enumerate}
  ...
  \item Create a GitHub repository for your project and link it to the
    ...
    \href{https://get.slack.help/hc/en-us/articles/232289568-GitHub-for-Slack}{GitHub
      for Slack} integration). % I think only admins on slack (only Jeremy) can do this
...
existing protocol is more appropriate for your study, discuss with
...
schedules of grad students and undergraduates.
  ...
  \item We use the \href{http://calendar.google.com/PLACEHOLDER-LINK}{PBS department events calendar} to keep track of talks and events happening in the department.
