...
week for group projects.  All of our meetings are hybrid: you can attend in person in Moore 416 or via Zoom. The Zoom link is posted in the \texttt{\#general} Slack channel at the start of each term and is used for all lab Zoom meetings unless otherwise noted. We have the following regularly scheduled
meetings:

\begin{itemize}
  \item \textbf{Lab meetings.} We hold weekly lab meetings. During the first week of each term,
...
During lab meetings, we typically focus on things that project teams want input on beyond their immediate group. We also use lab meetings to discuss logistics, give feedback on upcoming talks or poster presentations, and share project updates that might be of interest beyond one project team. Generally we spend most of the time going around the room and having each person give a brief informal update about something they are working on, planning to work on, or thinking about.
