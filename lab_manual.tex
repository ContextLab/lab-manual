...
\newcommand{\labmeetingtime}{Tuesdays at noon}
...
accomplish various necessary administrative tasks: \marginnote{\texttt{TASK:} Create (free) Google and GitHub
  accounts.  Send your GMail address and GitHub username to \coordinator~so
  that you can be added to the lab groups.  Also initiate a request to
join our slack workspace via
...
\item \href{http://calendar.google.com}{Google Calendar}:
  ...
  \item We use the
    ...
    hospital equipment, software licenses, etc.
  \item We use the
    ...
    holidays, etc.).  \marginnote{\texttt{TASK:} If you are a graduate
      ...
      class schedule calendar at the beginning of each term.}
  \item We use the
...
\item I have submitted a pull request to the
  ...
  section, along with any other updates I think would be helpful.
  ...
  \item I have submitted a photograph (of myself, or a representative
    ...
    Alternatively, I have coordinated with \coordinator~to indicate my
