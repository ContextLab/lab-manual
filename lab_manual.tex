...
\item A brief description of the event and/or other relevant
  information
\Checkmark Attach any relevant documents via Google Docs
\end{itemize}
\end{itemize}
...
\chapter{Checklist and signature page}
   ...
   \begin{todolist}
     \item \checkmark I have joined the lab's Slack account and worked through the
    ...
    onboarding process.)
    \item \checkmark I agree to check Slack
  ...
  \item \checkmark I have created a GitHub account and have been added to the appropriate lab
...
\item \checkmark I have submitted a pull request to the
  \href{https://github.com/ContextLab/lab-manual}{GitHub repository}
  ...
  \item \checkmark I have been added to the lab's 1password account if I am a
    senior lab member, or I have not been added because I am a junior
    lab member.
  \item \checkmark I have completed the required CITI program module(s) and have
    sent my Completion Certificate(s) to \coordinator.
  \item \checkmark I am an unpaid or salaried employee, or I am an hourly
    employee and have gotten myself set up on Kronos to track my paid
    hours.
    \item \checkmark If I am a paid employee (including graduate students), or if
  ...
  \item \checkmark I have submitted a photograph (of myself, or a representative
  ...
  \item \checkmark I agree to regularly attend lab meetings (unless I have a
    course conflict and have informed \director).
  \item \checkmark I agree to set up a beginning-of-term or end-of-term meeting
    with \director~at least once per term.
    \item \checkmark I agree to send \director~regular updates regarding my
      progress and work, including weekly snippets, meetings, Slack
      discussions, and/or GitHub updates.
      \item \checkmark If/when I decide to end my affiliation with the lab, I
  ...
  \item \checkmark I have read
    ...
    environments.
  \item \checkmark I have reviewed the
    \href{https://oir.nih.gov/sites/default/files/uploads/sourcebook/documents/ethical_conduct/guidelines-authorship_contributions.pdf}{NIH
      guidelines for authorship}.
  \item \checkmark I agree to abide by the lab's bill of rights and
    responsibilities, and to follow official lab practices and
    policies.
  \item \checkmark I have carefully read through the entire lab manual, and I
    have checked off all of the above items to indicate that I have
    carried out the indicated tasks.
  \item \checkmark I will send a digital copy (PDF) of the final two pages of
