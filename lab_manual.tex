...
\marginnote{\texttt{TASK:} Create (free) Google, Trello, and GitHub
  ...
  and \director~so that you can be added to the lab groups.  Also
...
Basic Course} module.  To complete the course, you will need to:
\begin{enumerate}
 \marginnote{\texttt{NOTE:} If you have conducted research before through a class or
 another lab, you may already have completed the \textbf{Group 2: Social/Behavioral 
Basic Course} module.  If your certificate is valid (i.e., it is less than 3 years old), you may
send it to \coordinator~without completing the course again.}
\item Create an account on \href{https://about.citiprogram.org}{CITI's website}.
    ...
    your account.  Dartmouth will cover the fee for your course.
\item Select \textbf{Group 2: Social/Behavioral Basic Course} as your registration course.
    If you also need to complete the biomedical course, you will be able to add it
    after completing the social/behavioral course.
\item Read/watch the the course material and complete the questions at the end of
    the module.  You will need to achieve a score of at least an 80\% to pass.
\end{enumerate}
...
Course} module \textit{in addition} to the social/behavioral course.  If you will be working
on a NSF-funded project, you may also need to complete the \textbf{Responsible Conduct
of Research (RCR)} module.}

\noindent Once you have finished the course, send your \textbf{Completion
