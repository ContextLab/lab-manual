...
\marginnote{\texttt{TASK:} Create (free) Google and GitHub
  accounts.  Send your addresses and/or usernames to \coordinator~so that you can be added to the lab groups.  Also
...
\marginnote{\texttt{NOTE:} If you create a new Slack channel for your project, invite \director~and other team members to join.}
