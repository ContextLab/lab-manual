...
\noindent \marginnote{\texttt{TASK:} email \coordinator~to request invites to each of the calendars below---the download links in the lab manual are read-only!}
