...
approach and some basic lab policies.  The manual also describes your
rights and responsibilities as a member of the lab.
...
\newthought{Who is this lab manual for?}  \marginnote{\texttt{TASK:}
  ...
  that's unclear, add a comment via the \href{https://github.com/ContextLab/lab-manual/issues}{GitHub issues page}, etc.  Importantly, be sure to submit
  a pull request with your edits to the manual's
  \href{https://github.com/ContextLab/lab-manual}{GitHub
...
\marginnote{\texttt{TASK:} When you are done reading this manual and
  ...
  \textbf{You are not an official lab member until you have completed
    all tasks in this manual and receipt of your signed and filled-out
    signature page is acknowledged by \director~or \coordinator.}}
...
this is that place.  We also maintain a repository of
...
\section{Your rights as a lab member}
\begin{enumerate}
\item You are entitled to a safe work environment free from
  harrassment, abuse, violence, and discrimination in any form.
  ...
  \item You are entitled to appropriate credit (authorship,
    acknowledgement, letter of recommendation) for your work and
    ideas.
\end{enumerate}

\section{Your responsibilities as a lab member}
\begin{enumerate}
  \item You agree to contribute to a safe work environment, refrain
    from behaviors that harrass, abuse, expose to violence, or
    discriminate.
  \item You agree to support and respect all lab members, including
    yourself.
  \item You agree to share your scientific ideas and constructive
  ...
  \item You agree to establish open lines of communication between
    yourself and other lab members, to address concerns or issues promptly and
  ...
  \item You agree to carry out your work with integrity and diligence,
    adhearing to the highest possible standards of scientific
    excellence.
  ...
  \item You agree to maintain a clean workspace free from clutter,
    including both private spaces (e.g.\ personal desks) and public
...
senior staff member (e.g.\ \director, Department Chair, Deans, polics,
...
The agile approach to research we use in the Contextual Dynamics Lab
...
forcast out over an extended timeline.  Although it's often helpful to
...
\item Value \textbf{working, intuitive, tools and research products} over
  \textit{comprehensive documentation}.  Documentation is important!
  But if our research products are designed in an intuitive way, they
  can (in some sense) serve as their own documentation.  An intuitive
  tool or research product with decent documentation is always preferable to a unintuitive
  tool or research product with comprehensive documentation.
...
\item Welcome changing goals and requirements, even late in the process.  Doing
  ...
  incompatable with your data.  Learn from these challenges and grow
  with them.  Avoid getting ``stuck'' by refusing to change.

\item Deliver research products frequently, from a couple of weeks to
  a couple of months, with a preference for shorter timescales.
  Before you have something to show for your work (a figure, a
...
\item Aim to get some amount of work done \textit{every single day} on
  ...
  someone might be yourself in the future!).  Remember that your
  greatest ally is your past self, but they'll never respond to email or
  Slack messages!  Help ``future you'' maintain peak efficiency
  through slow and steady, well-documented, work.  (Note: don't spend
...
\item The most effective and efficient method of conveying information
  to and within a research team is face-to-face conversation.  We use
  the
  \href{https://calendar.google.com/calendar?cid=NXRhNTBjZnY0dWloMGEwazhtMmRpOWRoam9AZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{CDL
    Google calendar} to coordinate formal meetings between lab
  members.  You can also sign up for meetings with \director~via
  \href{https://context-lab.youcanbook.me/}{YouCanBook.Me}.  We also
  use Slack to coordinate, share notes/data, etc., but the ideal form
  of communication in the lab is face-to-face (and it often involves a whiteboard).
...
\item Agile research is sustainable research.  Researchers should be
  ...
  far more efficient to make gradual progress over an extended
  timeframe than to lump all of your work time into a single period.
  By distributing your workload you'll help yourself avoid burnout,
  preserve your mental and physical health, allow yourself time to
...
\item At regular intervals, the team reflects on how to become more
  ...
  \item What your goals are for the upcoming term (start-of-term
    meetings), or what you worked on over the prior term (end-of-term meetings)
...
\item Capturing empirical data to adjust forecasts (e.g.\ weekly Slack
...
\item Usually the Lab Coordinator (\href{mailto:contextualdynamics@gmail.com}{\coordinator}) will also be the Project Coordinator
\end{enumerate}
...
\marginnote{\texttt{TASK}: If you are a senior
    ...
    meetings, but may shedule a time to do so upon request by
    coordinating with \director.  Exception: if you are presenting
...
\item \textbf{Lab meeting.}  We will have, as a lab, a regular weekly
  1.5 hour meeting on \textbf{Wednesdays at 12:30pm}.  The precise
  format of this meeting varies from week to week according to lab
  needs and interests. Attendees: all active lab members.  Subscribe
  to calendar \href{https://calendar.google.com/calendar?cid=NXRhNTBjZnY0dWloMGEwazhtMmRpOWRoam9AZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
\item \textbf{Project meetings.}  Several of our collaborative
  ...
  lab members.  Subscribe
  to calendar \href{https://calendar.google.com/calendar?cid=NXRhNTBjZnY0dWloMGEwazhtMmRpOWRoam9AZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
  \item \textbf{Hackathons.}  We occassionally organize hackathon
  ...
  \item \textbf{Department talks and colloquia.} Each week the
    ...
    members.  Subscribe to calendar
    \href{https://calendar.google.com/calendar?cid=bXAxYnVqYjM5dWQ1YmdtbW5xOXI4ZGJpdWtAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{here}.
\end{enumerate}
...
\item \href{https://www.github.com}{\textbf{GitHub.}}
  ...
  GitHub repositories.
  \item \href{https://1password.com/}{\textbf{1Password.}} This
      platform is used by senior lab members to manage secure notes
      and passwords (e.g.\ shared software licenses, card numbers and
      chart strings, etc.).  Request an invite from \director~in order
      to be added to the lab 1password account.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Create a GitHub repository for your project and link it to the
    project's Slack channel (through a
...
\director~whether it would be appropriate to create a new protocol or
submit an ammendment for an existing protocol.
...
\section{Scheduling}
\marginnote{\texttt{TASK:} email \coordinator~to request invites to each of the calendars below.}
...
\item \href{http://calendar.google.com}{Google Calendar}:
  ...
  \item We use the \href{https://calendar.google.com/calendar/ical/j6noo2tqahpsoq9na1h16paf3s\%40group.calendar.google.com/private-c3d75bea1ab4605947353d159d3dcd05/basic.ics}{DHMC events
...
\item We use the \href{https://calendar.google.com/calendar/ical/h1j06dohcg7v1g2o5tkb7ijhvs\%40group.calendar.google.com/private-239aaf8b4dc60480c90e8d7fc353e229/basic.ics}{out-of-lab calendar} to keep track of known
  ...
  equipment, such as testing rooms, our EEG systems, eyetracker, hospital
...
appropriate arrangements.  \textbf{With the above in mind, we abide by
  ...
  system.}\marginnote{\texttt{TIP:} If you are a (paid) hourly
...
\item If you are scheduled to present at a conference (i.e.\ you
  ...
  work.  In the extremely rate event that an emergency situation
...
or community and are having trouble resolving it on your own (or feel
...
\href{https://github.com/ContextLab/cluster-tools-dartmouth}{sample
 ...
 \marginnote{\texttt{NOTE}: To obtain funding for a scientific
   ...
   in with your goals and/or plans, (b) provide confirm that you have
   applied for some form of external funding, and (c) provide an
   ...
   submitting receipts, etc.)}A major
   component of doing scientific research is communicating with other
   scientists.  The Contextual Dynamics Lab regularly presents at
   several international scientific conferences.  If you are
   presenting your work from the lab (i.e., you are the presenting
   author for a talk or poster), then your travel expenses and
   conference registration fees will be guaranteed by the lab,
   \textit{under the assumption that you will also make reasonable
     efforts to seek out alternative sources of travel funding} (e.g.\
   through PBS, other internal Dartmouth sources, apply for travel
   awards, use personal grants like NRSAs or NSF fellowships, etc.).
   ...
   room with other lab members, etc.).  By the same token, we also
   want to be cognizant of your comfort and time, and it is not always
...
need access to RAPPORT then let \director~know.
 ...
 \item \textbf{Efficient Learning (STUDY00029685).}  Used for all
   ...
   eyetrackers, and/or performing physical tasks like riding on a
 ...
 \begin{enumerate}
   \item \textbf{EEG Efficient Learning (STUDY00029881).} Analog of
     the Efficient Learnign protocol, but allows for scalp EEG data
...
\begin{todolist}
\item I am proficient in \LaTeX or have completed a \LaTeX tutorial,
  allowing me to edit and understand this lab manual's source code.
...
\item I have joined the lab's Slack account and agree to check it
  ...
  \item I have coordinated with \director~about getting added to the
    weekly snippets Howdy script.
  \item I have obtained access to the following lab calendars:
  ...
  \item I have created a GitHub account and have been added to the lab
    GitHub group.  If I am unfamiliar with Git, I have gone through
    the GitHub tutorials.
  \item I have created a Trello account and have been added to the lab
    Trello group.
  \item I have been added to the lab's 1password account if I am a
    senior lab member, or I am a junior lab member.
  \item I agree to regularly attend lab meetings (unless I have a course
    conflict and have informed \director~or \coordinator).
  \item I am either an unpaid or salaried employee, or I am an hourly
  ...
  \item I have submitted a photograph (of myself, or a
    ...
    website-- or I have coordinated with \coordinator~to indicate my
  ...
  \item I agree to abide by the lab's Bill of rights and
    ...
    policies.
  \item I have read and understood the entire lab manual, and have
    checked off all of the above items to indicate that I have carried
    out the indicated tasks.
  \item I agree to send a digital copy (PDF) of the final two pages of
