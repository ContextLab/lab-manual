...
senior staff member (e.g.\ \director, Department Chair, Deans, polices,
...
\item The current status of the various components of the project
...
\item \textbf{Project meetings.}  Several of our collaborative
  ...
  \item \textbf{Department talks and colloquia.} Each week the
    ...
    \item \textbf{Howdy weekly snippets.} Each week (via Slack), all
      ...
      Your answers are then compiled into reports that I receive each
      Tuesday at the end of the day (5pm).  If you are an unpaid
      employee but are likely to request a letter of recommendation,
      weekly snippets are a good way for me to maintain a detailed
      sense of what you are working on from week to week and how you
      are progressing over time.  (Virtual) attendees: all paid lab
      members and any other lab members who want to participate.
\end{enumerate}
...
\item \href{https://1password.com/}{\textbf{1Password.}}
  ...
  software licenses, card numbers and chart strings, etc.).  Request
  an invite from \director~in order to be added to the lab 1password
  account.
\item \href{http://www.context-lab.com/}{\textbf{Lab website.}}
  \marginnote{\texttt{TASK:} Submit a photograph (of yourself or some
    other picture or image that you want to represent you) and brief
    2-3 sentence biography to \coordinator~so that you can be added to
    the \href{http://www.context-lab.com/people/}{people page} on the
...
\noindent \marginnote{\texttt{TASK:} email \coordinator~to request invites to each of the calendars below.}
...
DHMC.
\marginnote{\texttt{TASK:} If you are an undergraduate, please add your
  schedule to the CDL class schedule calendar at the beginning of each term.}
\item We use the
  \href{https://calendar.google.com/calendar?cid=djJzZWxvbWc0bzZhb2J1YTdnOTIyYWFtcWNAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ}{CDL
  class schedule calendar} to keep track of course
schedules of undergraduates.
...
lab.  \coordinator~can help facilitate these payments.
 ...
 Most in-lab experimental subjects will be paid via t-points.
 ...
 Cash subject payments for lab research projects will be fully covered by
...
\item I have submitted one or more edits to the lab manual by making a
  pull request or adding an issue via the
