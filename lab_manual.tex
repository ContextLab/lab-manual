...
\noindent \marginnote{\texttt{TASK:}
  ...
  focus on for own edits if you'd like.  Importantly, be sure to submit
...
\item You are entitled to a safe work environment free from
  ...
  \item You are entitled to appropriate credit (authorship,
    ...
    ideas.This includes being credited in conversation (for example, "As Karen said, I agree we should..." Rather than, "Again, I think we should...")
\end{enumerate}
