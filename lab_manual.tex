...
\marginnote{\texttt{TASK:} Watch the
  ...
  and answer the quiz questions. (Note: ``Scrum'' is an implementation
...
Our \href{http://agilemanifesto.org/}{agile science manifesto} has three key
tenets:
\begin{enumerate}
\item Value \textbf{individuals and interactions} over
  \textit{processes and tools}.
\item Value \textbf{working tools and research products} over
...
described below, we use \href{http://www.slack.com}{Slack} to facilitate non-in-person
communications, but Slack cannot replace in-person meetings.  In fact,
our approach is set up to encourage in-person interactions as often as
possible-- ideally at least once per day.  We'll have the following
...
\item \textbf{Lab meeting.}  We will have, as a lab, a regular weekly
  ...
  meeting time to prioritize the research backlog and plan sprints for
...
\item \href{https://context-lab.slack.com}{\textbf{Slack.}}  This is where
  ...
  an account without an invitation.  Otherwise you'll need to get invited by the Lab Coordinator.

\item \href{https://www.trello.com}{\textbf{Trello.}}  This is used to
  manage all projects and tasks.  It provides a way of tracking
  progress and impediments to progress.  You'll need to sign up for a
...
\item \href{http://calendar.google.com}{Google Calendar}.  We use the
  ...
  etc.).\marginnote{\texttt{TASK:} ask the Lab Coordinator to send you
...
\end{itemize}
 ...
 provide a reason for your absence (although you are honor bound not
...
\begin{itemize}
\item It is your responsibility to notify anyone your absence will
  affect (e.g. people you're scheduled to meet with, etc.).  The best
  way to do this is via email or Slack.  We also use an \href{https://calendar.google.com/calendar/ical/h1j06dohcg7v1g2o5tkb7ijhvs\%40group.calendar.google.com/private-239aaf8b4dc60480c90e8d7fc353e229/basic.ics}{``out-of-lab''
...
postdoctoral researcher, or lab coordinator, then the lab will cover
