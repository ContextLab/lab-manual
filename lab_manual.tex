...
options with \director.
 ...
 There are many options for poster creation. One option is to create a slide in Powerpoint, Keynote, or a similar application, and export to PDF for printing. Sample/template posters, with the correct scale and resolution, including both the Dartmouth seal and Contextual Dynamics Lab logo, for powerpoint (.pptx) can be found \href{http}{here}. 
